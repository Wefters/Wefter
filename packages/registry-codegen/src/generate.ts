...
import { extractWefterHooks, extractWefterMethods, findMalformedWefterHooks, findMalformedWefterMethods } from './extract-wefter-plugin.js';
import {
...
const outFile = resolve(
  repoRoot,
  'shells/android-template/app/src/main/java/dev/wefter/bridge/GeneratedRegistry.kt'
);
